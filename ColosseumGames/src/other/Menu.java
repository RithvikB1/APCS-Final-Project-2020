...
public class Menu {
	...
	private int cmouseX, cmouseY, dmouseX, dmouseY, pressMouseY, pressMouseX;
	...
	public void drawSettingsMenu(PApplet marker, PImage g, int mouseX, int mouseY) {
		...
		Rectangle backButton = new Rectangle(35, 450, 130, 100);
		Rectangle slider = new Rectangle(200, 200, 30, 70);
		
		PShape shape = marker.createShape(PConstants.RECT, 35, 450, 130, 100, 20);
		PShape shape2 = marker.createShape(PConstants.RECT, 200, 200, 30, 70);
		...
		else if (slider.contains(mouseX, mouseY)) {
			shape2.setFill(c2);
		}
