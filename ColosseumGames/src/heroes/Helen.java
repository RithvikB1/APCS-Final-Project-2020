...
public class Helen extends Hero {
	...
	public static final int SPEED = 20, ATK_SPEED = 10, HP = 60000, RANGE = 400, DAMAGE = 300;
	public static final int UP_SPEED = 5, UP_ATK_SPEED = 5, UP_HP = 6000, UP_RANGE = 30, UP_DAMAGE = 75;
